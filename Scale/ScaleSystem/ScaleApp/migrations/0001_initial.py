...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Ticketnum', models.CharField(max_length=255)),
                ('Docnum', models.CharField(max_length=30)),
                ('Truckno', models.CharField(max_length=15)),
                ...
                ('CanId', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ScaleApp.scale')),
                ('Custcode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ScaleApp.customer')),
                ('Prodcode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ScaleApp.product')),
            ],
            options={
                'ordering': ['-id'],
            },

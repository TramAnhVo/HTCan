...
const FromDateProduct = () => {
    ...
    // bo gia tri cho combobox hang hoa 
    ...
    const handleConfirm = () => {
        ...
        if (value === null && valueItem === null) {
            ...
            setErrorMessageItem('Bạn phải chọn hàng hóa!')
        }
        else {
            if (value !== null && valueItem === null) {
                setErrorMessageItem('Bạn phải chọn hàng hóa!')
                ...
                if (value === null && valueItem !== null) {
                    ...
                    navigation.navigate('SearchProduct', { yearFrom, monthFrom, dayFrom, yearTo, monthTo, dayTo, value, valueItem });
                }
            }
        }
    };
        ...
        <View style={{ padding: 10 }}>
            ...
            <View>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
                    ...
                    <View style={{ marginLeft: '7%', width: '60%' }}>
                        <Dropdown
                ...
                {errorMessage ?
                    <Text style={{ color: 'red', fontSize: 14, textAlign: 'center', marginTop: 2, marginLeft: '12%' }}>{errorMessage}</Text> : null}

                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
                    <Text style={{ fontSize: 15, marginRight: 5, fontWeight: '700' }}>Hàng hóa:</Text>
                    <View style={{ marginLeft: '7%', width: '60%' }}>
                        <Dropdown
                ...
                {errorMessageItem ?
                    <Text style={{ color: 'red', fontSize: 14, textAlign: 'center', marginTop: 2, marginLeft: '25%' }}>{errorMessageItem}</Text> : null}

                <TouchableOpacity style={styles.SreachButton} onPress={handleConfirm}>
                    <Text style={{ color: 'white', textAlign: 'center', fontSize: 15, fontWeight: '700' }}>Tìm kiếm</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
...
export default FromDateProduct;
